...
# all cpp files here
SOURCES = main.cpp Menu.cpp Animation.cpp Wall.cpp Collider.cpp Player.cpp Room.cpp Projectile.cpp Weapon.cpp AssaultRifle.cpp AK47.cpp M16.cpp Shotgun.cpp SawedOff.cpp Pump.cpp Enemy.cpp FastEnemy.cpp Item.cpp Heals.cpp TankyEnemy.cpp NormalEnemy.cpp HUD.cpp LaserGun.cpp
